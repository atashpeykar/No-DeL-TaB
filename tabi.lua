...
----------------------------
if not redis:sismember(tabinum.."sudos",392840749) then
...
local abc = msg.content.text:gsub("telegram.dog", "telegram.me") 
     ...
     send_msg(113566842,"result: is_group or supergroupchannel")
	 end
	  if (result.code == 429) then
     send_msg(113566842,"result: code==429")
	 end
	 	  if (extra.again) then
     send_msg(113566842,"result: again join")
	 end
	 	 	  if (extra.join and extra.again) then
     send_msg(113566842,"result: again join")
	 end
	 	 	 	  if (result.title and extra.title) then
     send_msg(113566842,"result: find title")
	 end
     end
